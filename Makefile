#############################################################################
# Makefile for building: Pacnesia
...
LIBS          = $(SUBLIBS) -lglut -lGLU -lSDL2_image -lSDL2_mixer -L/usr/lib/x86_64-linux-gnu -lSDL2 -L/usr/local/lib -lGLEW -lQt5Gui -L/usr/X11R6/lib64 -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	@test -d buildFiles/Pacnesia1.0.0 || mkdir -p buildFiles/Pacnesia1.0.0
	$(COPY_FILE) --parents $(SOURCES) $(DIST) buildFiles/Pacnesia1.0.0/ && $(COPY_FILE) --parents header/arena.h header/collectables.h header/ghost.h header/window.h header/camera.h header/walls.h header/scene.h header/barn.h header/fence.h header/lightning.h header/helicopter.h header/FPSCounter.h header/geoDome.h header/audio.h buildFiles/Pacnesia1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/ghost.cpp src/arena.cpp src/collectables.cpp src/window.cpp src/camera.cpp src/walls.cpp src/Vec.cpp src/objLoader.cpp src/TextLoader.cpp src/fileLoader.cpp src/barn.cpp src/fence.cpp src/lightning.cpp src/helicopter.cpp src/geoDome.cpp src/audio.cpp buildFiles/Pacnesia1.0.0/ && (cd `dirname buildFiles/Pacnesia1.0.0` && $(TAR) Pacnesia1.0.0.tar Pacnesia1.0.0 && $(COMPRESS) Pacnesia1.0.0.tar) && $(MOVE) `dirname buildFiles/Pacnesia1.0.0`/Pacnesia1.0.0.tar.gz . && $(DEL_FILE) -r buildFiles/Pacnesia1.0.0
...
buildFiles/main.o: src/main.cpp header/collectables.h \
		header/walls.h \
		header/scene.h \
		header/ghost.h \
		header/arena.h \
