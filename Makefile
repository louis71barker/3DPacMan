...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) buildFiles/PacMan3D1.0.0/ && $(COPY_FILE) --parents header/arena.h header/collectables.h header/player.h header/ghost.h header/window.h header/camera.h header/walls.h header/torch.h header/scene.h header/lights.h header/skyDome.h header/barn.h header/fence.h header/lightning.h header/helicopter.h buildFiles/PacMan3D1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/player.cpp src/ghost.cpp src/arena.cpp src/collectables.cpp src/window.cpp src/camera.cpp src/walls.cpp src/torch.cpp src/Vec.cpp src/objLoader.cpp src/lighting.cpp src/TextLoader.cpp src/fileLoader.cpp src/skyDome.cpp src/barn.cpp src/fence.cpp src/lightning.cpp src/helicopter.cpp buildFiles/PacMan3D1.0.0/ && (cd `dirname buildFiles/PacMan3D1.0.0` && $(TAR) PacMan3D1.0.0.tar PacMan3D1.0.0 && $(COMPRESS) PacMan3D1.0.0.tar) && $(MOVE) `dirname buildFiles/PacMan3D1.0.0`/PacMan3D1.0.0.tar.gz . && $(DEL_FILE) -r buildFiles/PacMan3D1.0.0
...
buildFiles/lightning.o: src/lightning.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o buildFiles/lightning.o src/lightning.cpp

buildFiles/helicopter.o: src/helicopter.cpp 
